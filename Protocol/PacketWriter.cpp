...
ARC::Void Tortuga::PacketWriter::writeChar ( const ARC::UnsignedChar value )
{
	this->buffer.push_back ( value ) ;
}
ARC::Void Tortuga::PacketWriter::writeShort ( const ARC::UnsignedShort value )
{
	this->buffer.push_back ( ( value >> 8 ) & 0xFF ) ;
	this->buffer.push_back ( ( value ) & 0xFF ) ;
}
ARC::Void Tortuga::PacketWriter::writeInt ( const ARC::UnsignedInt value )
{
...
ARC::Void Tortuga::PacketWriter::writeLong ( const ARC::UnsignedLong value )
{	
...
ARC::Void Tortuga::PacketWriter::writeFloat ( const ARC::Float value )
{
...
ARC::Void Tortuga::PacketWriter::writeBool ( const ARC::Bool value )
{
