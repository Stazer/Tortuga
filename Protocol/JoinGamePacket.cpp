...
Tortuga::JoinGamePacket::JoinGamePacket ( const ARC::UnsignedInt entityIdentification , const ARC::UnsignedChar gamemode , const ARC::SignedChar dimension , const ARC::UnsignedChar difficulty , const ARC::String & levelType ) :
...
ARC::Void Tortuga::JoinGamePacket::setEntityIdentification ( const ARC::UnsignedInt entityIdentification )
{
...
ARC::Void Tortuga::JoinGamePacket::setGamemode ( const ARC::UnsignedChar gamemode )
{
...
ARC::Void Tortuga::JoinGamePacket::setDimension ( const ARC::SignedChar dimension ) 
{
...
ARC::Void Tortuga::JoinGamePacket::setDifficulty ( const ARC::UnsignedChar difficulty )
{
...
ARC::Void Tortuga::JoinGamePacket::setMaximalPlayers ( const ARC::UnsignedChar maximalPlayers )
{
